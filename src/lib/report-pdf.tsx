...
import type { BusinessInfo } from '@/lib/invoice-pdf'
...
const s = StyleSheet.create({
  ...
  logoImage: { width: 32, height: 32, borderRadius: 6, marginBottom: 6, objectFit: 'contain' },
    ...
    React.createElement(Page, { size: 'A4', style: s.page },
      ...
      React.createElement(View, { style: s.header },
        React.createElement(View, null,
          business?.logoUrl
            ...
            : React.createElement(View, { style: s.logo }, React.createElement(Text, { style: s.logoText }, initials)),
          React.createElement(Text, { style: s.companyName }, bizName),
          business?.address ? React.createElement(Text, { style: s.companyDetail }, business.address) : null,
          business?.email ? React.createElement(Text, { style: s.companyDetail }, business.email) : null,
          business?.phone ? React.createElement(Text, { style: s.companyDetail }, business.phone) : null,
        ),
        React.createElement(View, null,
      ...
      React.createElement(View, { style: { marginTop: 40, paddingTop: 16, borderTopWidth: 1, borderTopColor: '#f1f5f9' } },
        React.createElement(Text, { style: { fontSize: 8, color: '#94a3b8', textAlign: 'center' } },
          `Generated by ${bizName} · ${new Date().toLocaleDateString('en-EG')}`
        )
      )
    )
